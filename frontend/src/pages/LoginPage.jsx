...
function LoginPage() {
  ...
  // [NUEVO] Efecto que se ejecuta solo al cargar la página de login
  useEffect(() => {
    ...
    if (queryParams.get("expirado") === "true") {
      ...
      // Limpiamos la URL para quitar el ?expirado=true (opcional pero muy elegante)
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3 form-check d-flex justify-content-between align-items-center">
            ...
            {/* Opcional: un enlace de "Olvidé mi contraseña" quedaría genial aquí a la derecha */}
            <a href="#" className="text-primary text-decoration-none small">¿Has olvidado tu contraseña?</a>
          </div>
        ...
        >
          <svg className="me-2" width="18" height="18" viewBox="0 0 18 18">
            ...
            <path
              fill="#FBBC05"
              d="M3.964 10.71A5.41 5.41 0 0 1 3.682 9c0-.593.102-1.17.282-1.71V4.958H.957C.347 6.173 0 7.547 0 9a8.998 8.998 0 0 0 .957 4.042l3.007-2.332z"
            />
            <path
              fill="#EA4335"
