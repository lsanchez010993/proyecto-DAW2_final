...
function IniciarSesionPage() {
  const { email, setEmail, password, setPassword, recordar, setRecordar, handleSubmit } = useIniciarSesion();
...
>
  ...
  >
    ...
    <button
      ...
      onClick={() => toast.success(APP_MESSAGES.NOTIFICATIONS.GOOGLE_SOON)}
    >
