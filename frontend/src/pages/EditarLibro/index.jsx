...
function EditarLibroPage() {
    const M = APP_MESSAGES.PAGES.EDITAR_LIBRO;
    ...
    <form onSubmit={handleSubmit}>
      <div className="row">
        ...
        <div className="col-md-5 mb-4">
          <h4 className="mb-3 fw-bold">{M.PORTADA_TITULO}</h4>
          ...
          >
            {imageToShow ? (
              ...
              <span className="text-muted">{M.PORTADA_SIN_IMAGEN}</span>
            )}
        ...
        <div className="col-md-7">
          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h2 className="fw-bold m-0 text-truncate" style={{ maxWidth: "70%" }}>
              {formData.titulo || M.TITULO_FALLBACK}
            </h2>
          </div>
          <h4 className="mb-3 fw-bold">{M.DATOS_TITULO}</h4>

          {/* Contenedor gris con los campos editables */}
          <div className="bg-light p-4 rounded-4 border">
            
            <div className="mb-3">
              <label className="form-label text-muted small">{M.LABEL_TITULO}</label>
            ...
            <div className="row">
              <div className="col-md-6 mb-3">
                <label className="form-label text-muted small">{M.LABEL_AUTOR}</label>
                <input type="text" name="autor" className="form-control border-0 shadow-sm" value={formData.autor} onChange={handleChange} required />
              </div>
              <div className="col-md-6 mb-3">
                <label className="form-label text-muted small">{M.LABEL_ISBN}</label>
            ...
            <div className="row">
              <div className="col-md-4 mb-3">
                <label className="form-label text-muted small">{M.LABEL_FISICO}</label>
              ...
              <div className="col-md-4 mb-3">
                <label className="form-label text-muted small">{M.LABEL_DIGITAL}</label>
              ...
              <div className="col-md-4 mb-3">
                <label className="form-label text-muted small">{M.LABEL_STOCK}</label>
            ...
            <div className="mb-4">
              <label className="form-label text-muted small">{M.LABEL_SINOPSIS}</label>
